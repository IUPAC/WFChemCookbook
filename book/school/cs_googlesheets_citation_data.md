...
```{figure} ../images/crossref_api.jpg
---
alt: JSON file of citation metadata from the CrossRef API
width: 100%
align: center
---
A JSON file of metadata about a research article accessed via the CrossRef API
```
